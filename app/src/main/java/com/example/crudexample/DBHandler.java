...
//      CREATE TABLE todo(id INTEGER PRIMARY KEY AUTOINCREMENT,title TEXT,description TEXT,started TEXT,finished TEXT);
    ...
    @Override
    //drop table and create a new table when version number is changed
    public void onUpgrade(SQLiteDatabase db, int i, int i1) { //table upgrade
    ...
    public List<Todo> getAllTodo() {
        ...
        //data base eke data tynwda kyla check karanawa
        //moveTo first raw in tha table
        //do-while loop eka aniwaryen eka parak hari run wenwa
        //while loop eka run wenne condition eka hari gyt witarai
